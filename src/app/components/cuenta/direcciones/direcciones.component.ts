...
export class DireccionesComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.identity) {
      ...
      // https://api.countrylayer.com/v2/all?access_key=d71f6106fedda6cde410f994486b0caa
      this.http.get('https://api.countrylayer.com/v2/all?access_key=d71f6106fedda6cde410f994486b0caa').subscribe(
        data => {
